 ...
 *
 */
public class HangmanGameSuccessView extends GameFinishedView {



	public HangmanGameSuccessView(LevelContext levelContext, OnResumeToDashboardItf onResumeToDashboardItf, GameScore gameScore) {
